...
package_name = 'iros_ru_voice_recognision'
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'voice_controller = iros_ru_voice_recognision.nodes.voice_controller:main',
            'water_proc = iros_ru_voice_recognision.nodes.water_proc:main',
        ],
    },
)
