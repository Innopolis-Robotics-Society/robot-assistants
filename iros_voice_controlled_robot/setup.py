...
package_name = 'iros_voice_controlled_robot'
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'voice_controller = iros_voice_controlled_robot.nodes.voice_controller:main',
            'water_proc = iros_voice_controlled_robot.nodes.water_proc:main',
        ],
    },
)
