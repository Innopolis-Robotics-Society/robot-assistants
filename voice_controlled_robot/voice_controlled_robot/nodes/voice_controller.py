...
from voice_controlled_robot.utils.grammar_utils import generate_grammar
from voice_controlled_robot.utils.command_parser import match
...
class VoiceController(Node):
    ...
    def __init__(self):
        ...
        pkg_path = get_package_share_directory('voice_controlled_robot')
